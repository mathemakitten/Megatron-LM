...
# The SM100 TRT-LLM block-scale runner has no valid tactic for the observed
# 256-row routed-MoE shape. 512 is the smallest capacity verified by the E2E workload.
